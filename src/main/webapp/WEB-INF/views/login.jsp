...
<body>
		...
		<fieldset>
			<form action="login" method="post" id="target">
				...
				<div class="input">
					...
					<input type="text" name="id" placeholder="Username" required /> <span>
						<i class="fas fa-id-card-alt"></i>
					</span>
				</div>
				<div class="input">
					<input type="password" placeholder="Password" name="password"
						required /> <span> <i class="fas fa-lock-open"></i>
					</span>
				</div>
				<div>
					<a href="joinForm"><p class="joinff">create an account</p></a>
					<a href="findForm">find</a>
					
				</div>
				<button type="submit" value="sign in" class="submit">
	...
	<script>
		...
		$('#target').submit(
				function(event) {
					$(this).find(".submit i").removeAttr('class').addClass(
							"fa fa-check").css({
						"color" : "#fff"
					}, 60000);
					$(".submit").css({
